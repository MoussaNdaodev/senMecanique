...
@endsection
@section('title','SEN MECANIQUE || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
												...
												<p class="price"><span class="discount">{{number_format($after_discount_CFA)}} XOF</span><s>${{number_format($price_CFA)}} XOF</s> </p>
															...
															<div class="col-12">
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		<span>Based on {{$product_detail->getReview->count()}} Commentaires</span>
																	</div>
