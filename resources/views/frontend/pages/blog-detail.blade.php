...
@section('title','Sen Mecanique || Blog Detail page')
                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4">
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        <h2 class="reply-title">Ajouter un commentaire</h2>
                                        <!-- Comment Form -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Publiez</span><span class="comment_btn reply" style="display: none;">Répondre au commentaire</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                Vous devez vous <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Connecter</a> ou <a style="color:blue" href="{{route('register.form')}}">vous inscrire</a> pour ajouter des commentaires.
                            ...
                            <div class="letter-inner">
                                ...
                                <form action="{{route('subscribe')}}" method="POST">
                                    ...
                                    <div class="form-inner">
                                        ...
                                        <button type="submit" class="btn mt-2">Envoyez</button>
                                    </div>
                                </form>
                            </div>
                        </div>
