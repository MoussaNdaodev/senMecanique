                    ...
                    <div class="right-bar d-flex align-items-center justify-content-end">
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="{{ route('wishlist') }}" class="single-icon">
                                ...
                                <span class="total-count">{{ App\Http\Helper::wishlistCount() }}</span>
                            </a>
                            @auth
                                    ...
                                    <ul class="shopping-list">
                                        @foreach(App\Http\Helper::getAllProductFromWishlist() as $data)
                                            ...
                                            <li>
                                                ...
                                                <a class="cart-img" href="#"><img src="{{ asset($photo[0]) }}" alt="{{ $data->product['title'] }}"></a>
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="{{ route('cart') }}" class="single-icon">
                                ...
                                <span class="total-count">{{ App\Http\Helper::cartCount() }}</span>
                            </a>
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
