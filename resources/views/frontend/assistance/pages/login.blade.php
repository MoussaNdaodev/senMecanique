...
<div class="container-fluid m-0 p-0" style="width: 100%;height:100vh">
    <div class="row w-100 h-100">
        ...
        <div class="col-12 col-md-12 col-lg-6 h-100">
            ...
            <div class="row w-100">
                <form class="form w-75" style="margin:auto;" method="post" action="{{route('ClientLogin.submit')}}">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label>Votre Email<span>*</span></label>
                                <input type="email" name="email" class="form-control" placeholder="" required="required" value="{{old('email')}}">
                                @error('email')
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control" placeholder="" required="required" value="{{old('password')}}">
                                @error('password')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col text-center w-100 mb-2">
                                    ...
                                    <button class="btn"><a href="{{route('Clientregister.form')}}">Inscription</a></button>
                                </div>
