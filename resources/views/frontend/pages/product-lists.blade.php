...
@section('title','Sen Mecanique || PRODUCT PAGE')
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                <p class="price"><del class="text-muted">{{number_format($price_CFA)}} XOF</del>   ${{number_format($after_discount_CFA)}} XOF </p>
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    @endforeach
											...
											<div class="row">
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Ajoutez à la liste de souhait</span></a>
																</div>
																<div class="product-action-2">
																	<a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">Ajoutez au panier</a>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="javascript:void(0)" class="btn cart" data-id="{{$product->id}}">Achetez Maintenant!</a>
													</div>
												</div>
											</div>
										</div>
