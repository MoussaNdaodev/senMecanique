								...
								@else
										<tr>
											<td class="text-center">
												Il n'y a aucun panier disponible. <a href="{{route('product-grids')}}" style="color:blue;">Continuer vos achats</a>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{\App\Http\Helper::totalCartPrice()}}">Sous-total du panier<span>${{number_format(\App\Http\Helper::totalCartPrice(),2)}}</span></li>
									...
									<div class="button5">
										...
										<a href="{{route('product-grids')}}" class="btn">Continuez vos achats</a>
									</div>
								</div>
							</div>
						</div>
